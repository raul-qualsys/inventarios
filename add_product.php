               ...
               <div class="row">
                 ...
                 <div class="col-md-4">
                   <div class="input-group">
                     ...
                     <input type="float" class="form-control" name="buying-price" placeholder="Precio de compra">
                  ...
                  <div class="col-md-4">
                    <div class="input-group">
                      ...
                      <input type="float" class="form-control" name="saleing-price" placeholder="Precio de venta">
                      <!--span class="input-group-addon">.00</span-->
                   </div>
                  </div>
               </div>
